...
```
  ...
  -h, --help                                       help for template
      ...
      --keyring string                             location of public keys used for verification (default "/Users/oisinkyne/.gnupg/pubring.gpg")
...
```
  ...
  -n, --namespace string                namespace scope for this request
      ...
      --registry-config string          path to the registry config file (default "/Users/oisinkyne/Library/Preferences/helm/registry/config.json")
      --repository-cache string         path to the directory containing cached repository indexes (default "/Users/oisinkyne/Library/Caches/helm/repository")
      --repository-config string        path to the file containing repository names and URLs (default "/Users/oisinkyne/Library/Preferences/helm/repositories.yaml")
```
